...
- "technical": a technical report for the engineering team. For each failed check, explain the risk and give a concrete remediation (with example header/DNS config when relevant). Markdown allowed.
...
- "technical": informe técnico para el equipo de ingeniería. Para cada check fallido, explica el riesgo y da una remediación concreta (con ejemplo de config de header/DNS cuando aplique). Se permite Markdown.
